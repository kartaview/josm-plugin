...
public class DetectionTypeList extends JPanel {
    ...
    public void populateDetectionList(final List<String> selectedSignTypes, final List<Sign> selectedSpecificSigns,
    ...
    public List<String> getSelectedTypes(final String searchFieldText) {
    ...
    public List<Sign> getSelectedValues() {
