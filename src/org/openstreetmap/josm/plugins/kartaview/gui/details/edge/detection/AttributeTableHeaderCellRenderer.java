...
/**
 * Custom cell renderer for the header of the custom attribute table in the Edge detection panel.
 *
 * @author maria.mitisor
 */
class AttributeTableHeaderCellRenderer extends DefaultTableCellRenderer {

    private static final long serialVersionUID = -1671394161279133337L;
