 ...
 * and corresponding actions of a selected detection or cluster.
 *
 * @author ioanao
 * @version $Revision$
 */
public final class DetectionDetailsDialog extends ToggleDialog {
    ...
    private DetectionDetailsDialog() {
        super(GuiConfig.getInstance().getDetectionDialogTitleName(), IconConfig.getInstance()
                .getDetectionDialogShortcutName(), GuiConfig.getInstance().getPluginDetectionShortcutLongText(),
                ShortcutFactory.getInstance().getShortcut(GuiConfig.getInstance().getPluginDetectionShortcutText()),
    ...
    public void changeClusterDetailsDialog(final boolean isClusterInfoDisplayed) {
        ...
        if (DataSet.getInstance().hasSelectedCluster() && DataSet.getInstance().hasSelectedDetection()) {
            if (!isClusterInfoDisplayed) {
                final Cluster cluster = ServiceHandler.getInstance().retrieveClusterDetails(DataSet.getInstance()
                ...
                final KartaViewLayerSelectionHandler selectionHandler = new KartaViewLayerSelectionHandler();
