...
public class RemoteSelectionHandler {
    ...
    private final static int LON_POZ = 1;
    private final static int FACING_POZ = 2;
    private final static int INTERNAL_NAME_POZ = 3;

    private final KartaViewLayerSelectionHandler selectionHandler = new KartaViewLayerSelectionHandler();
            ...
            ThreadPool.getInstance().execute(() -> {
                ...
                if (clusters != null && !clusters.isEmpty()) {
                    ...
                    if (selectedCluster.isPresent()) {
                        ...
                        selectionHandler.handleMapDataUnselection();
                    }
                }
            });
        }
